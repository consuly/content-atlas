...
from ..dependencies import detect_file_type, analysis_storage
from ..b2_utils import download_file_from_b2 as _download_file_from_b2
...
from ..file_analyzer import analyze_file_for_import as _analyze_file_for_import, sample_file_data
...
def _get_analyze_file_for_import():
    ...
    try:
        from .. import main as main_module  # Local import avoids circular dependency at import time
