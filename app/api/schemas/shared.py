...
class WorkflowVariable(BaseModel):
    """Variable definition for a workflow"""
    name: str
    display_name: Optional[str] = None
    variable_type: str = "text"  # text, date, number, select
...
class WorkflowStep(BaseModel):
    ...
    prompt_template: str  # Contains {{variable}} placeholders
...
class CreateWorkflowRequest(BaseModel):
    ...
    def validate_steps(cls, value: List[WorkflowStep]) -> List[WorkflowStep]:
...
class ExecuteWorkflowRequest(BaseModel):
    ...
    variables: Dict[str, Any]  # {"client_name": "Acme", "start_date": "2025-01-01"}
...
class WorkflowResponse(BaseModel):
    """Response for single workflow"""
    success: bool
    workflow: Optional[WorkflowDetail] = None
    error: Optional[str] = None
...
class WorkflowExecutionDetailResponse(BaseModel):
    """Response for single execution detail"""
    success: bool
